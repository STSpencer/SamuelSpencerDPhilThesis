...
\subsection{H.E.S.S.}
\subsection{VERITAS}
VERITAS consists of 4 10 meter parabolic, single mirror IACTs at the Fred Lawrence Whipple Observatory in Arizona (the original VERITAS design intended 8 IACTs). It is designed to give optimal sensitivity in 100GeV to 10TeV energy band.
...
Charge integration is the process of taking a calibrated PMT trace and extracting the number of photoelectrons. Various schemes exist for performing this operation, CHEC/SSTCAM relies on a cross-correlation template fitting model developed by J. Watson.
