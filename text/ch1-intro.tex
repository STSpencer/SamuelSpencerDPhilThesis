...
\end{equation}
we can obtain a photon distribution function for the scattering in the Klein-Nishina limit ($\Gamma_{\epsilon}\gg 1$), where an electron in the distribution looses the vast majority of its energy in a single interaction with a photon \cite{blumenthal} (the case for many very-high-energy $\gamma$-ray sources)
\begin{equation}
...
\subsection{SNRs, Pulsar Wind Nebulae and Pulsars}
