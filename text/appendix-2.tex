...
\begin{table}[htpb]
    ...
    \caption{NSB rate statistics in MHz, now taken over mean values per TM for the four Eta Carinae observing runs.}
...
\begin{table}[htpb]
    ...
    \caption{Maximum change in NSB rate in MHz between adjacent TMs, taken over mean values per TM for the four Eta Carinae observing runs.}
...
\begin{table}[htpb]
    ...
    \caption{Change in mean NSB rate per TM over 30 minutes for the four Eta Carinae observing runs.}
