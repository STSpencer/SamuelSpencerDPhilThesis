...
\item[1D, 2D, 3D] One, two or three dimensional, referring in this thesis to spatial (or temporal) dimensions in an image.
...
\item[DL] Deep Learning. Refers to machine learning with a large number of intermediate `hidden' layers between the input and output layers (or equivalently a high degree of abstraction of learned features).
\item[EAS] Extensive Air Shower; a particle cascade in the atmosphere.
\item[ENF] Excess Noise Factor; a physical property of SiPMs.
